...
function Contacts() {
  return (
      <div className='w-full h-full bg-gray-600 text-black px-10 py-16 flex gap-10'>
          <div className='w-1/2 h-screen flex flex-col justify-between '>
          <div className="heading">
           <h1 className='font-bold text-8xl tracking-tighter -mb-5 '>EYE-</h1>     
           <h1 className='font-bold text-8xl tracking-tighter '>OPENING</h1>      
          </div>
      ...
      <div className='details mt-10 '>
        <h1 className='font-semibold mt-10 mb-5 text-xl'>Social Media:</h1>       
        ...
        <a className='block text-xl mb-10' href="#">Linkedin</a> 
        <h1 className='font-semibold mt-50 mb-5 text-xl'>Location:</h1>       
        <a className='block text-xl ' href="#">202-1965 W 4th Ave</a>
        <a className='block text-xl mb-5' href="#">Vancouver, Canada</a>
        <a className='block text-xl' href="#">30 Chukarina St</a>        
        <a className='block text-xl mb-16' href="#">Lviv, Ukraine</a> 
        <h1 className='font-semibold mt-50 mb-5 text-xl'>E-mail:</h1>       
        <a className='block text-xl ' href="#">hello@projektt.design</a>          
        </div>     
      </div>
    </div>
  )
